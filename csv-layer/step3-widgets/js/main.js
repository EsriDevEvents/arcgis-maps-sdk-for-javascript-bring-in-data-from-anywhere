/**
 * Step 3: Widgets
 * Description: Demonstrates how to add the LayerList, Legend, and Search
 * widgets to the application. The Search widget uses the CSVLayer as a search source, so
 * a feature can be found using the widget by searching using the CITY field.
 */
require([
  "esri/Map",
  "esri/views/MapView",
  ...
  Map, MapView, CSVLayer, Legend, LayerList, Search
) {
  ...
  const popupTemplate = {
    ...
    content: [
      {
        type: "text",
        text: `A <b><span style="color: #39AB17">{Shape}</span></b> shaped UFO was spotted on {DateTime} in <b>{CITY}</b>.
